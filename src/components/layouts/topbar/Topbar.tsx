                    ...
                    <div className="d-flex">
                        ...
                        <div className="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                            ...
                            <div className="dropdown-item bg-transparent text-wrap">
                                <a href="index-2.html" className="btn btn-soft-secondary btn-sm btn-rounded">how to setup <i className="mdi mdi-magnify ms-1" /></a>
                                <a href="index-2.html" className="btn btn-soft-secondary btn-sm btn-rounded">buttons <i className="mdi mdi-magnify ms-1" /></a>
                            </div>
                            {/* item*/}
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-auto">
                                <span className="badge badge-soft-warning fs-13"><span className="cartitem-badge">7</span> items
                                </span>
                                </div>
                            </div>
                            </div>
                        ...
                        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div className="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <h6 className="mt-0 mb-2 lh-base">Your <b>Elite</b> author Graphic Optimization <span className="text-secondary">reward</span> is ready!
                                        </h6>
                                        </a>
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative">
                                    ...
                                    <div className="px-2 fs-15">
                                        <div className="form-check notification-check">
                                        <input className="form-check-input" type="checkbox" defaultValue={''} id="all-notification-check02" />
                            ...
                            <div className="notification-actions" id="notification-actions">
                                ...
                                Select
                                <div id="select-content" className="text-body fw-semibold px-1">0</div> Result <button type="button" className="btn btn-link link-danger p-0 ms-3" data-bs-toggle="modal" data-bs-target="#removeNotificationModal">Remove</button>
                                </div>
                            </div>
                            </div>
                        </div>
